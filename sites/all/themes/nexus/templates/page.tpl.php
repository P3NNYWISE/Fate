...
-->
      ...
      <div class="col-sm-7   mainmenu">
	    ...
	    <img src="http://www.fate.com.ar/site/img/es/bt_idioma_1.jpg" width="15" height="20" border="0" style="cursor:pointer;">
	    <img src="http://www.fate.com.ar/site/img/es/bt_idioma_2.jpg" width="15" height="20" border="0" style="cursor:pointer;">
	 

                       
              <i class="fa fa-graduation-cap" aria-hidden="true"></i>             
              <a class="upper-menu" href="http://webcampus.fate.com.ar/login/index.php">Campus Virtual</a> &nbsp;&nbsp;
               
              <i class="fa fa-lock" aria-hidden="true"></i>
              <a  class="upper-menu" href="http://webcampus.fate.com.ar/login/index.php">Distribuidores</a>&nbsp;&nbsp;

              <i class="fa fa-envelope" aria-hidden="true"></i>
               
              <a class="upper-menu"href="/contacto">Contacto</a>&nbsp;&nbsp;
      ...
      <li>
        ...
        <?php if($slide1_head || $slide1_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide1_url); ?>"> <?php print t('Leer Mas'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
      <li>
        ...
        <?php if($slide2_head || $slide2_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide2_url); ?>"> <?php print t('Leer Mas'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
      <li>
        ...
        <?php if($slide3_head || $slide3_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide3_url); ?>"> <?php print t('Leer Mas'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
    </ul><!-- /slides -->
